export default {
  name: 'pushups and crab walks',
  phases: [
    {
      label: 'Warm up',
      steps: [
        { color: '#f4a641', label: 'arm circle steps', time: 30 },
        { color: '#f4a641', label: 'arm cross steps', time: 30 },
